...
const products = [
  ...
  },
  {
    ...
    size: ['s', 'l', 'xl'],
    description:
      'Áo polo nam Coolmax phối vai được ra mắt trong thời điểm mùa hè với chất liệu cực mát, khả năng thấm hút cực tốt cùng thiết kế áo thời thượng, mới mẻ giúp bạn hoàn toàn tự tin mặc đẹp mỗi ngày.<br><br>Đặc điểm nổi bật<br><br>Chất liệu siêu mát với bề mặt độc đáo.<br><br>Áo polo nam Coolmax phối vai được tạo nên từ 2 sợi vải là Coolmax và spandex. Với thành phần sợi Coolmax chiếm đến 95% và sợi spandex chiếm 5%.'
  },
  {
    ...
    size: ['s', 'l', 'xl'],
    description: `Chiếc áo sơ mi tay ngắn vải vỏ hàu luôn được lựa chọn bởi sự cá tính và thoải mái cho các bạn nam vào những ngày hè oi bức. Chất liệu vải thân thiện với môi trường được Yolo mang đến chiếc Áo Sơ Mi Nam Tay Ngắn Vải Vỏ Hàu tuyệt vời với nhiều ưu điểm giúp các bạn nam tự tin, thoải mái.<br><br>Đặc điểm áo sơ mi nam ngắn tay vải vỏ hàu SCM4027 <br>Chất liệu vải thân thiện với môi trường <br><br>Yolo luôn hướng tới những thành phần thân thiện với môi trường (Eco-friendly) để cho ra đời những dòng sản phẩm thời trang nam mà xu hướng mới của toàn cầu. Trong số các nguyên liệu sản xuất ra sợi vải thân thiện thì có nguyên liệu đặc biệt là vỏ hàu. Hàng năm có hàng triệu tấn vỏ cho ra môi trường biển. Vải vải vỏ hàu - Oyster Shell Fabric được tạo nên nhờ sự kết hợp giữa vỏ hàu và sợi PET tái chế. Với nhiều ưu điểm như khử mùi, chống tĩnh điện hiệu quả, thấm hút mồ hôi tốt và mang đến cảm giác mặc mềm mại, thoải mái. Mẫu vải cực kì phù hợp với các mẫu áo dành cho công sở.`
  },
  {
    ...
    size: ['s', 'm', 'l', 'xl'],
    description: `Một trong những trang phục cơ bản mà mọi người đều sở hữu trong tủ đồ là chiếc quần jeans. Chiếc quần jeans nam trở nên quen thuộc trong mọi kiểu phối đồ mà bạn có thể bắt gặp ở rất nhiều nơi. Đơn giản và đẹp là yếu tố tạo nên sự phổ biến của nó. Cùng Yolo tìm hiểu mẫu Quần Jeans Nam Đen Trơn Ống Đứng nhé!<br><br>Đặc điểm quần jeans nam QJM4003<br>Chất liệu vải denim bền bỉ<br>Vải denim Yody được cấu tạo từ các thành phần 98% sợi cotton và 2% sợi spandex. Đây được coi là mẫu denim có giá thành khá cao đi cùng với đó là những ưu điểm vượt trội. Vải denim có độ bền cao, vải dày, ít bị nhắn và không bị sờn rách sau một thời gian sử dụng.`
  }
]
